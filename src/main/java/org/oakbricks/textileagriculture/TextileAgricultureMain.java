...
public class TextileAgricultureMain implements ModInitializer {
	...
	public static final ConfiguredFeature<?, ?> AVOCADO_TREE = Feature.TREE
			...
			.configure(new TreeFeatureConfig.Builder(
					...
					new AvocadoTrunkPlacer(8, 3, 0), // places a straight trunk
					...
					new AvocadoFoliagePlacer(ConstantIntProvider.create(5), ConstantIntProvider.create(0), ConstantIntProvider.create(3)), // places leaves as a blob (radius, offset from trunk, height)
